...
struct FILE_TRANSFER_PROTOCOL : mavlink::Message {
    ...
    std::array<uint8_t, 251> payload; /*<  Variable length payload. The content/format of this block is defined in https://mavlink.io/en/services/ftp.html. The length is defined by the remaining message length when subtracting the header and other fields. See also MAV_FTP_OPCODE and MAV_FTP_ERR. */
